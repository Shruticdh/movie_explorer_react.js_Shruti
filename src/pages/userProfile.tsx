...
// //       // FIXED: Merge the response data with existing user data to preserve all fields
// //       const updatedUser = {
// //         ...user, // Keep all existing user data
// //         ...response.data, // Update with new data from server
// //         // Ensure critical fields are preserved if they're missing from response
...
// //     }
// //   }, [selectedFile, navigate, user]); // Added 'user' to dependencies
...
// //       // FIXED: Only update profile picture related fields, preserve all other data
// //       const updatedUser = {
// //         ...user,
...
// //                 const value = isDateField ? formatDate(user[field]) : user[field];
...
// //                       {getFieldLabel(field)}:
// //                     </p>
// //                     <p className={`text-white ${['role', 'plan_type'].includes(field) ? 'capitalize' : ''}`}>
// //                       {value || "N/A"}
// //                     </p>
// //                   </div>
// //                 );
...
const UserProfile = () => {
  ...
  // Helper function to get plan styling based on plan_validity
  const getPlanStyling = (planValidity) => {
    switch(planValidity) {
      ...
      case 'premium': // fallback for premium without validity
        return {
  ...
  // Helper function to format plan validity for display
  ...
  const fetchUser = useCallback(async () => {
    try {
      ...
      // Set plan based on plan_type from API response
  ...
  // Get styling based on plan_validity
