...
//   const [like, setLike] = useState<Movie[]>([]);
...
//   const likeInView = useInView(likeRef, { once: true });
...
//       try {
//       const response = await getMoviesByGenre("Action");
//       const movies = response?.movies || response;
//       if (movies && Array.isArray(movies)) {
//         setLike(movies.slice(0, 10));
//       } else {
//         console.warn("No valid action movies data:", movies);
//         setLike([]);
//       }
...
//       {renderCarousel('', like, likeRef, likeInView)}
//     </div>
//   );
// };
