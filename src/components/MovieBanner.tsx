...
const MovieBanner: React.FC = () => {
  ...
  // Check if user has premium access for this movie
  const hasPremiumAccess = !currentMovie.is_premium || userPlan === "premium" || role === "supervisor";
      ...
      <div className="relative z-10 flex flex-col items-start justify-center min-h-250 md:min-h-200 text-left px-6 md:px-16 py-10 -mt-15">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Show details only if user has premium access OR movie is not premium */}
            {hasPremiumAccess && (
              <>
                <motion.div
                  variants={itemVariants}
            ...
            {/* Show upgrade message for premium movies when user doesn't have access */}
            {currentMovie.is_premium && !hasPremiumAccess && (
              <motion.div
                variants={itemVariants}
                className="mt-4"
              >
                <p className="text-gray-400 text-sm md:text-base mb-4">
                  Upgrade to Premium to unlock exclusive content and features.
                </p>
                <button 
